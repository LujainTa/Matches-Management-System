<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterAsClubRepresentative.aspx.cs" Inherits="MatchesManagementSystem.RegisterAsClubRepresentative" %>
...
<body style="background-color: wheat">
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="ClubName" runat="server" Placeholder="Club Name" Style="margin-left: 44%; margin-top: 1%; border-radius: 25px" Width="200" Height="30"></asp:TextBox>
