<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterAsFan.aspx.cs" Inherits="MatchesManagementSystem.RegisterAsFan" %>
...
<body style="background-color: wheat">
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="NationalIDNumber" runat="server" Placeholder="National ID Number" Style="margin-left: 44%; margin-top: 1%; border-radius: 25px" Width="200" Height="30"></asp:TextBox>
        <asp:TextBox ID="PhoneNumber" runat="server" Placeholder="Phone Number" Style="margin-left: 44%; margin-top: 1%; border-radius: 25px" Width="200" Height="30"></asp:TextBox>
        <asp:TextBox ID="BirthDate" runat="server" Placeholder="Birth Date" Style="margin-left: 44%; margin-top: 1%; border-radius: 25px" Width="200" Height="30" TextMode="DateTimeLocal"></asp:TextBox>
        <asp:TextBox ID="Address" runat="server" Placeholder="Address" Style="margin-left: 44%; margin-top: 1%; border-radius: 25px" Width="200" Height="30"></asp:TextBox>
