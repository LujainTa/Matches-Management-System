<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterAsStadiumManager.aspx.cs" Inherits="MatchesManagementSystem.RegisterAsStadiumManager" %>
...
<body style="background-color: wheat">
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="StadiumName" runat="server" Placeholder="Stadium Name" Style="margin-left: 44%; margin-top: 1%; border-radius: 25px" Width="200" Height="30"></asp:TextBox>
